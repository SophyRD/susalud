...
export class MacroprocesoUpdateComponent implements OnInit {
  isSaving = false;
  maFechaCreacionDp: any;
  maFechaModificacionDp: any;

  editForm = this.fb.group({
    id: [],
    idMacroproceso: [null, [Validators.required]],
    maFechaCreacion: [null, [Validators.required]],
    maFechaModificacion: [null, [Validators.required]],
    verificadorlIdVerificador: [null, [Validators.required]],
  });
  ...
  updateForm(macroproceso: IMacroproceso): void {
    this.editForm.patchValue({
      ...
      maFechaModificacion: macroproceso.maFechaModificacion,
      verificadorlIdVerificador: macroproceso.verificadorlIdVerificador,
    });
  }
  ...
  private createFromForm(): IMacroproceso {
    return {
      ...
      maFechaModificacion: this.editForm.get(['maFechaModificacion'])!.value,
      verificadorlIdVerificador: this.editForm.get(['verificadorlIdVerificador'])!.value,
    };
  }

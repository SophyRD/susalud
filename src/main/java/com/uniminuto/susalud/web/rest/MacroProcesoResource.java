...
/**
 * REST controller for managing {@link com.uniminuto.susalud.domain.MacroProceso}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MacroProcesoResource {
    ...
    public ResponseEntity<MacroProceso> updateMacroProceso(@RequestBody MacroProceso macroProceso) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, macroProceso.getId().toString()))
            .body(result);
    }

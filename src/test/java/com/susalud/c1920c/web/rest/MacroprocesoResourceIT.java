...
import com.susalud.c1920c.repository.MacroprocesoRepository;
...
public class MacroprocesoResourceIT {
    ...
    private static final LocalDate DEFAULT_MA_FECHA_CREACION = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_MA_FECHA_CREACION = LocalDate.now(ZoneId.systemDefault());

    private static final LocalDate DEFAULT_MA_FECHA_MODIFICACION = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_MA_FECHA_MODIFICACION = LocalDate.now(ZoneId.systemDefault());

    private static final Integer DEFAULT_VERIFICADORL_ID_VERIFICADOR = 1;
    private static final Integer UPDATED_VERIFICADORL_ID_VERIFICADOR = 2;
    ...
    public static Macroproceso createEntity(EntityManager em) {
        Macroproceso macroproceso = new Macroproceso()
            ...
            .maFechaModificacion(DEFAULT_MA_FECHA_MODIFICACION)
            .verificadorlIdVerificador(DEFAULT_VERIFICADORL_ID_VERIFICADOR);
        return macroproceso;
    }
    /**
    ...
    public static Macroproceso createUpdatedEntity(EntityManager em) {
        Macroproceso macroproceso = new Macroproceso()
            ...
            .maFechaModificacion(UPDATED_MA_FECHA_MODIFICACION)
            .verificadorlIdVerificador(UPDATED_VERIFICADORL_ID_VERIFICADOR);
        return macroproceso;
    }
    ...
    public void createMacroproceso() throws Exception {
        ...
        assertThat(testMacroproceso.getMaFechaModificacion()).isEqualTo(DEFAULT_MA_FECHA_MODIFICACION);
        assertThat(testMacroproceso.getVerificadorlIdVerificador()).isEqualTo(DEFAULT_VERIFICADORL_ID_VERIFICADOR);
    }
    ...
    public void checkIdMacroprocesoIsRequired() throws Exception {
        ...
        // set the field null
        macroproceso.setIdMacroproceso(null);
    ...
    @Test
    @Transactional
    public void checkMaFechaCreacionIsRequired() throws Exception {
        int databaseSizeBeforeTest = macroprocesoRepository.findAll().size();
        // set the field null
        macroproceso.setMaFechaCreacion(null);
    ...
    @Test
    @Transactional
    public void checkMaFechaModificacionIsRequired() throws Exception {
        int databaseSizeBeforeTest = macroprocesoRepository.findAll().size();
        // set the field null
        macroproceso.setMaFechaModificacion(null);
    ...
    @Test
    @Transactional
    public void checkVerificadorlIdVerificadorIsRequired() throws Exception {
        int databaseSizeBeforeTest = macroprocesoRepository.findAll().size();
        // set the field null
        macroproceso.setVerificadorlIdVerificador(null);
    ...
    public void getAllMacroprocesos() throws Exception {
        ...
        restMacroprocesoMockMvc.perform(get("/api/macroprocesos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].maFechaCreacion").value(hasItem(DEFAULT_MA_FECHA_CREACION.toString())))
            .andExpect(jsonPath("$.[*].maFechaModificacion").value(hasItem(DEFAULT_MA_FECHA_MODIFICACION.toString())))
            .andExpect(jsonPath("$.[*].verificadorlIdVerificador").value(hasItem(DEFAULT_VERIFICADORL_ID_VERIFICADOR)));
    }
    ...
    public void getMacroproceso() throws Exception {
        ...
        restMacroprocesoMockMvc.perform(get("/api/macroprocesos/{id}", macroproceso.getId()))
            ...
            .andExpect(jsonPath("$.maFechaCreacion").value(DEFAULT_MA_FECHA_CREACION.toString()))
            .andExpect(jsonPath("$.maFechaModificacion").value(DEFAULT_MA_FECHA_MODIFICACION.toString()))
            .andExpect(jsonPath("$.verificadorlIdVerificador").value(DEFAULT_VERIFICADORL_ID_VERIFICADOR));
    }
    @Test
    @Transactional
    ...
    public void updateMacroproceso() throws Exception {
        ...
        assertThat(testMacroproceso.getMaFechaModificacion()).isEqualTo(UPDATED_MA_FECHA_MODIFICACION);
        assertThat(testMacroproceso.getVerificadorlIdVerificador()).isEqualTo(UPDATED_VERIFICADORL_ID_VERIFICADOR);
    }

  ...
  describe('Alert Error Component', () => {
    ...
    describe('Error Handling', () => {
      ...
      it('Should display an alert on generic error', () => {
        // GIVEN
        eventManager.broadcast({ name: 'susaludApp.httpError', content: { error: { message: 'Error Message' } } });
        eventManager.broadcast({ name: 'susaludApp.httpError', content: { error: 'Second Error Message' } });
        // THEN
